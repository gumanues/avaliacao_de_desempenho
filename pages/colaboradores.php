...
<!-- Envios -->
  ...
  <div class="container py-2">
    <form action="/funcoes/envio_colab.php" method="post">
      <div class="mb-3">
        ...
        <select class="form-select" name="idusuario" id="idusuario" required>
          ...
          WHERE situacao = 1
            AND (
              ...
              OR (e.idusuario in($delega_tipo) AND NOT EXISTS (
                SELECT 1
                FROM colab a
...
$sql_perguntas = "SELECT * FROM pergunta a, modifica_pergunta b where a.id = b.colab";
