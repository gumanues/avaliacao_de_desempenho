...
<body>
  ...
  <div class="d-flex justify-content-center pt-2">
    ...
    <a href="avaliacoes_usuarios_coordenadores.php?id_tipo=null&idusuario=null&id_data=null" class="btn btn-secondary btn-lg m-2">Avaliação Por Usuário</a>
    <a href="avaliacoes_nao_realizadas_coordenadores.php?id_data=6&id_data=null" class="btn btn-outline-secondary btn-lg m-2">Usuários Pendentes</a>
    ...
    <input name="id_tipo" value="6" type="hidden" id="id_tipo" checked require>
      ...
      <div class="mb-3">
        ...
        <select class="form-select" name="idusuario" id="idusuario" required>
          ...
          $editar_usuarios = "SELECT * FROM usuario where situacao = 1 and idusuario not in ($delega_tipo, $id_login) and setorid = $setor_usuario order by nomecompleto ASC"; 
