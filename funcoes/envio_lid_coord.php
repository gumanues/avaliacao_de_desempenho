...
if ($idusuario != "") {
    ...
    INSERT INTO `gerencia` (`id`, `nota1`, `nota2`, `nota3`, `nota4`, `nota5`, `nota6`, `nota7`, `nota8`, `nota9`, `nota10`, `texto1`, `texto2`, `texto3`, `texto4`, `texto5`, `texto6`, `texto7`, `texto8`, `texto9`, `texto10`, `setor`, `data`, `idsupervisor`, `idusuarios`, `perguntaid`) 
    VALUES (
        NULL, 
        NULLIF('$nota1', 0),
        NULLIF('$nota2', 0),
    ...
    header('Location: ../pages/lider-gerencia.php?retorno=9');

    } else {
    header('Location: ../pages/log-lider.php?retorno=9');
    }
